...
class List {
   ...
   */
	...
	// payload shape. We tested 8 plausible variants empirically against the
	// live API on 2026-05-15 and every one was silently dropped:
	//
	//   handler            originalValue   originalCategory   endpoint              opClass   result
	//   remove-category    yes             no                 /update-v2 (Rust ref) 3         silently dropped
	//   remove-category    yes             yes (full PBList)  /update-v2            3         silently dropped
	//   remove-category    no              yes                /update-v2            3         silently dropped
	//   delete-category    yes             yes                /update-v2            3         silently dropped
	//   remove-category    yes             no                 /update (legacy v1)   3         silently dropped
	//   remove-list-category yes           yes                /update-v2            3         silently dropped
	//   remove-category    yes             no                 /update-v2            0         silently dropped
	//   remove-category-by-id yes          no                 /update-v2            3         silently dropped
	//
	...
	// AnyListClient.deleteCategory in src/anylist-client.js does that and
	// throws a clear error if the server didn't actually apply the delete.
